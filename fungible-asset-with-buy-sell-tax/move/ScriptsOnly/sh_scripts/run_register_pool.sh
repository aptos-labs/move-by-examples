...
aptos move compile \
  --named-addresses taxed_fa_addr=$CONTRACT_ADDRESS,tfa_recipient_addr=0x20,thala_swap_v2_interface_addr=0x30,thala_swap_v2_router_interface_addr=0x40,hyperion_interface_addr=0x50

# Run the script
aptos move run-script \
	--assume-yes \
  --profile $SENDER_PROFILE \
  --compiled-script-path build/ScriptsOnly/bytecode_scripts/register_pool_2.mv
